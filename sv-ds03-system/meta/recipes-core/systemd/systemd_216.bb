...
SRC_URI = "git://anongit.freedesktop.org/systemd/systemd;branch=master;protocol=git \
		   ...
		   file://0001-systemd-change-tmpconf-40day.patch \
...
do_install() {
	...
	#sed -i -e 's/.*ForwardToConsole.*/ForwardToConsole=yes/' ${D}${sysconfdir}/systemd/journald.conf
	#sed -i -e 's/.*MaxLevelConsole.*/MaxLevelConsole=info/' ${D}${sysconfdir}/systemd/journald.conf
	#sed -i -e 's#.*TTYPath=.*#TTYPath=/dev/ttySiRF1#' ${D}${sysconfdir}/systemd/journald.conf
