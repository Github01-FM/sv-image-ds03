...
#This file is provided under GPLv2 only.
#Portions of this file are copied from http://pcmcia-cs.sourceforge.net/  --> https://sourceforge.net/projects/pcmcia-cs/files/pcmcia-cs/3.2.8/
